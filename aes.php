                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="post" action="">
                                ...
                                <div class="box-footer">
                                    <button type="submit" name="encrypt" value="Enkripsi"
                                ...
                                <label for="encrypttext" class="col-sm-2 control-label" style="margin-top: 8px;">Hasil
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        if (isset($_POST['encrypt'])) {
                                            // Mendapatkan plaintext dan kunci dari formulir
                                        ...
                                        $encryptedText = isset($encryptedText) ? $encryptedText : '';
                                        echo '<input class="form-control" type="text" placeholder="Hasil Enkripsi" name="hasil_enkripsi" id="hasil_enkripsi" value="' . $encryptedText . '">';
                                        ?>
...
<script>
    function copyText() {
      var inputElement = document.getElementById("hasil_enkripsi");
      inputElement.select();
