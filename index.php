            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-5">
                    <h5 class="card-title text-center pb-0 fs-2">Silahkan Pilih Kriptografi!!</h5>
                  ...
                  <style>
                                    .custom-btn {
                                        ...
                                        margin-bottom: 100px;
                                        border-radius: 150px;
                                        /* Menambahkan radius sudut untuk membuat tombol melengkung */
                                    }
                                    ...
                                    @media (min-width: 768px) {
                                        .custom-btn {
                                            width: 100%;
                                            margin-right: 1%;
                                            /* Menambahkan margin-right agar tombol tidak dempet */
                                            margin-bottom: 0;
                                        }
                                    }
                  ...
                  <div class="mt-30 button-container">
                                    <a class="btn btn-primary w-100" href="Caesar.php">Caesar Cipher</a><br>
                                    <a class="btn btn-primary w-100" href="aes.php">AES 128-CBC </a><br><br>
