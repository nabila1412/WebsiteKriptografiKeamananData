...
<head>
    ...
    <title>Caesar Chiper - Dekripsi</title>
    <!-- plugins:css -->
  ...
  <div class="row">
        ...
        <div class="card-body">
          ...
          <form class="forms-sample" method="post" action="">
                                        <div class="form-group">
                                            <label for="uppercaseInput"><b>Chipertext</b></label>
                                            <input type="text" name="input_text" class="form-control" placeholder="Masukkan Chipertext" style="font-family:'Times New Roman', Times, serif">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" name="submit2" class="btn btn-primary" style="font-family:'Times New Roman', Times, serif"><b>Proses</b></button>
                                        <br>
                                        <br>
                                        <style>
    ...
    input {
      ...
      text-transform: uppercase; /* Membuat semua teks menjadi huruf besar */
                                        ...
                                        ?>
                                        <div class="form-group">
                                            <label><b>Hasil Dekripsi</b></label>
